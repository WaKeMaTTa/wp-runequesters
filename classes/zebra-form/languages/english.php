...
$this->language = array(
    ...
    'days'          => array(
        'Sunday', WPRQ_TEXTDOMAIN),
        'Monday', WPRQ_TEXTDOMAIN),
        'Tuesday', WPRQ_TEXTDOMAIN),
        'Wednesday', WPRQ_TEXTDOMAIN),
        'Thursday', WPRQ_TEXTDOMAIN),
        'Friday', WPRQ_TEXTDOMAIN),
        'Saturday', WPRQ_TEXTDOMAIN)
    ),
